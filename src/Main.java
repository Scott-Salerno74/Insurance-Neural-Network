...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        //Buffered Reader in order to read in the File
        ...
        ArrayList<String> OGHeaderList = new ArrayList<>(); //ArrayList containing all headers before taking out a few

        //For loop to Fill in ArrayList
        for(int i = 0; i < OGHeaders.length; i++) {
            OGHeaderList.add(OGHeaders[i]);
        }
         //These are the headers we need from the database
        ...
        int[] indices = new int[headers.length]; //indices of the headers we need in the OGHeaders List

        // For loop to add data for only the headers we need into a new List
        ...
        // Method to write the header to a file
